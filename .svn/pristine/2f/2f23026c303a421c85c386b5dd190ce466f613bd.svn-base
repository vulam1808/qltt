...
class Model_CommodityBase{
    ...
    public function getCommodity(){return $this->_commodity;}
}
class Model_DbTable_Commodity extends Zend_Db_Table_Abstract{
    protected $_name="Commodity";
    protected $_primary="id";
}
class Model_CommodityMapperBase extends BaseMapper{
    protected $_dbTable;
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Commodity");
        }
        return $this->_dbTable;
    }
    public function save(Model_Commodity $entry){
        $data = array(
                'id' => $entry->getId(),
                'code' => $entry->getCode(),
                'name' => $entry->getName(), 
                'type_commodity' =>$entry->getCommodity(),
    ...
    public function find($id, Model_Commodity $entry){
        ...
        $entry->setId($row->id)
                ...
                ->setCommodity($row->type_commodity);
