...
class Model_DbTable_Print extends Zend_Db_Table_Abstract{
    protected $_name="print";
    protected $_primary="id";
}
class Model_PrintMapperBase extends BaseMapper{
    protected $_dbTable;
    public function setDbTable($dbTable)
    {
        ...
        if (!$dbTable instanceof Zend_Db_Table_Abstract) {
            throw new Exception("Invalid table data gateway print");
        }
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Print");
        }
        return $this->_dbTable;
    }
    public function save(Model_Print $entry){
        $data = array(
                'id' => $entry->getId(),
                'code' => $entry->getCode(),
                'name' => $entry->getName(),
    ...
    public function find($id, Model_Print $entry){
