 ...
 */
class Model_Type_CommodityBase{
    protected $_id;
    protected $_code;
    protected $_name;
    protected $_created;
...
class Model_DbTable_Type_Commodity extends Zend_Db_Table_Abstract{
    protected $_name="Type_Commodity";
    protected $_primary="id";
}
class Model_Type_CommodityMapperBase extends BaseMapper{
    protected $_dbTable;
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Type_Commodity");
        }
        return $this->_dbTable;
    }
    public function save(Model_Type_Commodity $entry){
        $data = array(
                'id' => $entry->getId(),
                'code' => $entry->getCode(),
                'name' => $entry->getName(),               
    ...
    public function find($id, Model_Type_Commodity $entry){
