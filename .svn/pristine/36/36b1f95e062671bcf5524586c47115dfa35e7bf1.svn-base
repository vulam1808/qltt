...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Bảng xử lý hàng hóa khi tịch thu hàng';
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='Bảng xử lý vi phạm';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `master_sanction` (
  ...
  `is_delete` tinyint(4) DEFAULT '0',
  `comment` varchar(255) DEFAULT NULL,
  `decree` varchar(45) DEFAULT NULL,
  `article` varchar(45) DEFAULT NULL,
  `clause` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='bảng danh mục hình thức xử lý';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-08-12 14:58:31
