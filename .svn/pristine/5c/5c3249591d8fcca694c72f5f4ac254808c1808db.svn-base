...
class Model_ProvinceBase{
    ...
    public function setProvince_Code($value){
        $this->_province_code=$value;
        return $this;
    }
    public function getProvince_Code(){return $this->_province_code;}
...
class Model_ProvinceMapperBase extends BaseMapper{
    protected $_dbTable;
    ...
    public function save(Model_Province $entry){
        $data = array(
                'id' => $entry->getId(),
                'code' => $entry->getProvince_Code(),
                'name' => $entry->getName(),               
    ...
    public function find($id, Model_Province $entry){
