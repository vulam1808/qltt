 ...
 */
class Model_Master_Business_SizeBase{
    protected $_id;
    protected $_name;  
    protected $_code;    
...
class Model_DbTable_Master_Business_Size extends Zend_Db_Table_Abstract
{
    protected $_name = "master_business_size";
    protected $_primary = "id";
}
class Model_Master_Business_SizeMapperBase extends BaseMapper{
     protected $_dbTable;
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Master_Business_Size");
        }
        return $this->_dbTable;
    }
    
    public function save(Model_Master_Business_Size $entry){
        $data = array(
                'id' => $entry->getId(),
                'name'=> $entry->getName(),  
                'code'=>$entry->getCode(),
    ...
    public function find($id,  Model_Master_Business_Size $entry){
     ...
     public function fetchPaging($page, $pageSize, $orderBy, $orderDirection, &$totalRecord, $filters=null)
    {
		...
		$queryTotal = "SELECT count(*) as totals FROM Master_Business_Size ".$sFilter."";
		$totalRecord = $this->getTotalRecords($queryTotal, $aFilterValues);
		$query = "SELECT * FROM Master_Business_Size ".$sFilter." order by ".$orderBy." ".$orderDirection." limit ".($page-1)*$pageSize.",".$pageSize."";
