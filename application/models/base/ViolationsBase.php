...
class Model_DbTable_Violations extends Zend_Db_Table_Abstract{
    protected $_name="Violations";
    protected $_primary="id";
}
class Model_ViolationsMapperBase extends BaseMapper{
    protected $_dbTable;
    public function setDbTable($dbTable)
    {
        ...
        if (!$dbTable instanceof Zend_Db_Table_Abstract) {
            throw new Exception("Invalid table data gateway Violations");
        }
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Violations");
        }
        return $this->_dbTable;
    }
    public function save(Model_Violations $entry){
        $data = array(
                'id' => $entry->getId(),
                'code' => $entry->getCode(),
                'name' => $entry->getName(),               
    ...
    public function find($id, Model_Violations $entry){
