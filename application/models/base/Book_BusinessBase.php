 ...
 */
class Model_Book_BusinessBase{
    protected $_id;    
    protected $_business_id;
    protected $_document_id;
    protected $_dated_checks;
    protected $_created;
    ...
    public function getBusiness(){return $this->_business_id;}
    ...
    public function setDated_Checks($value){
        $this->_dated_checks=$value;
        return $this;
    }
    public function getDated_Checks(){return $this->_dated_checks;}
...
class Model_DbTable_Book_Business extends Zend_Db_Table_Abstract{
    protected $_name="Book_Business";
    protected $_primary="id";
}
class Model_Book_BusinessMapperBase extends BaseMapper{
    protected $_dbTable;
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Book_Business");
        }
        return $this->_dbTable;
    }
    public function save(Model_Book_Business $entry){
        $data = array(
                'id' => $entry->getId(),
                'business_id' => $entry->getBusiness(),
                'document_id' => $entry->getDocument(), 
                'dated_checks'=>$entry->getDated_Checks(),
    ...
    public function find($id, Model_Book_Business $entry){
        ...
        $entry->setId($row->id)
                ->setId($row->id)
                ->setBusiness($row->business_id)
                ->setDocument($row->document_id)
                ->setDated_Checks($row->dated_checks)
