 ...
 */
class Model_Sys_User_GroupBase{
    protected $_id;
    ...
    {   
        ...
        if (("mapper" == $name) || !method_exists($this, $method)) {   
            throw new Exception("Invalid Sys_User_Group property");   
        }   
        $this->$method($value);   
    }   
...
class Model_DbTable_Sys_User_Group extends Zend_Db_Table_Abstract
{
    protected $_name = "sys_user_group";
    protected $_primary = "id";
}
class Model_Sys_User_GroupMapperBase extends BaseMapper{
     protected $_dbTable;
    public function setDbTable($dbTable)
    {
        ...
        if (!$dbTable instanceof Zend_Db_Table_Abstract) {
            throw new Exception("Invalid table data gateway Sys_User_Grouped");
        }
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Sys_User_Group");
        }
        return $this->_dbTable;
    }
    
    public function save(Model_Sys_User_Group $entry){
        $data = array(
                'id' => $entry->getId(),
     ...
     public function fetchPaging($page, $pageSize, $orderBy, $orderDirection, &$totalRecord, $filters=null)
    {
		...
		$queryTotal = "SELECT count(*) as totals FROM sys_user_group ".$sFilter."";
		$totalRecord = $this->getTotalRecords($queryTotal, $aFilterValues);
		$query = "SELECT * FROM sys_user_group ".$sFilter." order by ".$orderBy." ".$orderDirection." limit ".($page-1)*$pageSize.",".$pageSize."";
