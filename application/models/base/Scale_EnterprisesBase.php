 ...
 */
class Model_Scale_EnterprisesBase{
    protected $_id;
    protected $_code;
    protected $_name;
    protected $_created;
...
class Model_DbTable_Scale_Enterprises extends Zend_Db_Table_Abstract{
    protected $_name="scale_enterprises";
    protected $_primary="id";
}
class Model_Scale_EnterprisesMapperBase extends BaseMapper{
    protected $_dbTable;
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Scale_Enterprises");
        }
        return $this->_dbTable;
    }
    public function save(Model_Scale_Enterprises $entry){
        $data = array(
                'id' => $entry->getId(),
                'code' => $entry->getCode(),
                'name' => $entry->getName(),               
    ...
    public function find($id, Model_Scale_Enterprises $entry){
    ...
    public function fetchAll(){
        ...
        foreach ($result as $row){
            $entry = new Model_Scale_Enterprises();
            $entry->setId($row->id)
                 ->setId($row->id)
                ->setCode($row->code)
                ->setName($row->name)
