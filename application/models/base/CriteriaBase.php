...
class Model_CriteriaBase {
    protected $_id;
    protected $_name;
    protected $_alias;
    protected $_notes;
    protected $_type_criteria;  
    protected $_created;
    ...
    public function getTool(){return $this->_tool;}
    ...
    public function setType_Criteria($value){
        $this->_type_criteria=$value;
        return $this;
    }
    public function getType_Criteria(){return $this->_type_criteria;}
...
class Model_DbTable_Criteria extends Zend_Db_Table_Abstract
{
    protected $_name = "criteria";
    protected $_primary = "id";
}
class Model_CriteriaMapperBase extends BaseMapper{
     protected $_dbTable;
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Criteria");
        }
        return $this->_dbTable;
    }
    
    public function save(Model_Criteria $entry){
        $data = array(
                'id' => $entry->getId(),
                'name'=> $entry->getName(),
                'tool'=>$entry->getTool(),
                ...
                'type_criteria'=>$entry->getType_Criteria(),             
    ...
    public function find($id,  Model_Criteria $entry){
        ...
        $entry->setId($row->id)
                ...
                ->setAlias($row->alias)
                ->setNotes($row->notes)
                ->setType_Criteria($row->type_criteria)               
