 ...
 */
class Model_Type_DepartmentsBase{
    protected $_id;    
    protected $_name;
    protected $_created;
...
class Model_DbTable_Type_Departments extends Zend_Db_Table_Abstract{
    protected $_name="type_departments";
    protected $_primary="id";
}
class Model_Type_DepartmentsMapperBase extends BaseMapper{
    protected $_dbTable;
    public function setDbTable($dbTable)
    {
        ...
        if (!$dbTable instanceof Zend_Db_Table_Abstract) {
            throw new Exception("Invalid table data gateway Type_Departments");
        }
    ...
    public function getDbTable()
    {
        if (NULL === $this->_dbTable) {
            $this->setDbTable("Model_DbTable_Type_Departments");
        }
        return $this->_dbTable;
    }
    public function save(Model_Type_Departments $entry){
        $data = array(
                'id' => $entry->getId(),                
                'name' => $entry->getName(),               
    ...
    public function find($id, Model_Type_Departments $entry){
