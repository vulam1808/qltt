<?php
include APPLICATION_PATH . "/models/Master_Items_Condition.php";
/* 
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 */
class Master_MasterItemsConditionController extends Zend_Controller_Action{
    public function init(){       
        $bootstrap = $this->getInvokeArg("bootstrap");
        $this->aConfig = $bootstrap->getOptions();
        $this->view->aConfig = $this->aConfig;
        $this->modelMapper= new Model_Master_Items_ConditionMapper();
        $this->model= new Model_Master_Items_Condition(); 
    }
    public function indexAction(){      
    }
    public function addAction(){
        if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."master/masteritemscondition/list";
            if(isset($_POST["id"])){
    ...
    public function deleteAction(){
        $id= $this->_getParam("id","");
        $redirectUrl=$this->aConfig["site"]["url"]."master/masteritemscondition/list";               
        $this->modelMapper->deleteMaster_Items_Condition($id);
        $this->_redirect($redirectUrl);
    }    
