...
class Master_TypeCommodityController extends Zend_Controller_Action{
    ...
    public function addAction(){
        if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."master/typecommodity/list";
            if(isset($_POST["id"])){
...
//        }
    ...
    public function deleteAction(){
        $id= $this->_getParam("id","");
        $redirectUrl=$this->aConfig["site"]["url"]."master/province/list";                       
        foreach($this->DistrictmodelMapper->fetchAll() as $item)
        {
