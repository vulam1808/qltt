 ...
 */
class Master_DocPrintPaymentController extends Zend_Controller_Action{
...
//        $masterprintid = $this->_getParam('masterprintid','');
    ...
    public function indexAction(){       
     ...
     public function savedocprintpaymentAction(){
        ...
        if($this->getRequest()->isPost()){
           $redirectUrl = $this->aConfig["site"]["url"]."master/docprintpayment/list";
...
//            } 
            ...
            $redirectUrl = $this->aConfig["site"]["url"]."master/docprintpayment/listexport/pb/".$deparment."/us/".$us."" ;
