 ...
 */
class Master_DocPrintAllocationController extends Zend_Controller_Action{
    ...
    public function printallocationexportAction(){
        $this->_helper->layout->disableLayout();
            if($this->getRequest()->isPost()){
              $redirectUrl = $this->aConfig["site"]["url"]."master/docprintallocation/list";
...
//                   $this->modelMapper->updatesorderDoc_Print_Allocation();
    ...
    public function addAction(){
        ...
        $this->view->masterprintHTML = GlobalLib::getComboSeclectTitlee('master_print_id', 'master_print', 'id', 'code', 0,'name',  false,  'where id in (select distinct master_print_id from doc_print_create where is_delete ="0")',NULL, 'onchange="getPrintCreatWithMasterPrint(\'' . $this->aConfig["site"]["url"] .'master/service/index'. '\')"', 'Chưa lựa chọn');
