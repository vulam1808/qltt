 ...
 */
class Master_DocViolationsHandlingController extends Zend_Controller_Action{
    ...
    public function saveownerlessgoodsAction(){
        ...
        if($this->getRequest()->isPost()){
           $redirectUrl = $this->aConfig["site"]["url"]."master/docviolationshandling/listownerlessgoods";
...
//            $this->redirect($redirectUrl);
   ...
   ///
    ...
    public function indexAction(){ 
         if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."master/docviolationshandling/list";
            if(isset($_POST["id"])){
                $this->model->setId($_POST["id"]);
            }
