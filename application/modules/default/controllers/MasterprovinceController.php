 ...
 */
class MasterProvinceController extends Zend_Controller_Action{
    ...
    public function addAction(){
        if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."default/masterprovince/list";
            if(isset($_POST["id"])){
      ...
      public function importagentAction(){
        ...
        if ($this->_request->isPost()) {
            ...
            if (isset($_FILES['my_file'])) {
             ...
             $redirectUrl = $this->aConfig["site"]["url"] . "/default/tam/index";    
             $this->_redirect($redirectUrl);
               // exit();
