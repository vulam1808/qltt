<?php
  ...
  // include_once  APPLICATION_PATH."/models/Type_Departments.php"; 
    class SysDepartmentsController extends Zend_Controller_Action{
    //put your code here
    ...
    public function addAction() {
        ...
        if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."default/sysdepartments/list";            
            if(isset($_POST["id"])){
                $this->model->setId("id");
            }
    ...
    public function changepasswordAction() {
        ...
        $this->modelMapper->find($id,$this->model);
        $redirectUrl=$this->aConfig["site"]["url"]."default/admin/list"; 
        if($this->getRequest()->isPost()){         
