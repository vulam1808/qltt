 ...
 */
class DocPrintCreateController extends Zend_Controller_Action{
...
//            $this->exportdocprintcreate($ngay,1,$sohd);
//            $redirectUrl = $this->aConfig["site"]["url"]."default/docprintcreate/listexport/ngay/".$ngay."/sohd/".$sohd."";
             $redirectUrl = $this->aConfig["site"]["url"]."default/docprintcreate/listexport/ngay/$ngay1/sohd/$sohd1";
            $this->_redirect($redirectUrl);
        }
    } 
