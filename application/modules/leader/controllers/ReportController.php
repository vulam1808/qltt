 ...
 */
class Leader_ReportController extends Zend_Controller_Action{
  ...
  public function exportmangementprintAction() {
        $this->_helper->layout->disableLayout();
            $redirectUrl = $this->aConfig["site"]["url"]."leader/report/mangementprint";
...
//          
            ...
            $objPHPExcel->getActiveSheet()->getStyle('A1:V'.$rowCount)->getFont()->setName('Times New Roman');
            //tên file excel
...
//                 
    ...
    public function addAction(){
        if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."leader/masterunit/list";
            if(isset($_POST["id"])){
