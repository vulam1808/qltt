...
class Leader_DocItemsHandlingController extends Zend_Controller_Action{
       ...
       $type=$this->_getParam("type","");  
        ...
        if(empty($id)){
         ...
         if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."leader/docitemshandling/list";            
  ...
  public function servicetichthuAction(){
   ...
   public function deleteAction(){
    ...
    public function deletetttAction(){
        $id= $this->_getParam("id","");
        $redirectUrl=$this->aConfig["site"]["url"]."leader/docitemshandling/listtt";               
        $this->modelMapper->deleteDoc_Items_Handling($id);
        $this->_redirect($redirectUrl);
    } 
}
