<?php
    ...
    class Leader_InfoBusinessController extends Zend_Controller_Action{
    //put your code here
    ...
    public function serviceAction(){
        ...
        foreach ($this->modelMapper->fetchAll($type_business) as $items ) {
...
//         if($this->_request->isPost()){
             $id= $this->_getParam("id","");
              $urls = $this->aConfig["site"]["url"]."admin/docviolationshandling/listfrominfobusiness/id/".$id;
