...
class Leader_TypeCommodityController extends Zend_Controller_Action{
    ...
    public function addAction(){
        if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."leader/typecommodity/list";
            if(isset($_POST["id"])){
...
//        }
    ...
    public function deleteAction(){
        $id= $this->_getParam("id","");
        $redirectUrl=$this->aConfig["site"]["url"]."leader/province/list";                       
        foreach($this->DistrictmodelMapper->fetchAll() as $item)
        {
