 ...
 */
class Leader_DocViolationsHandlingController extends Zend_Controller_Action{
    ...
    public function saveownerlessgoodsAction(){
        ...
        if($this->getRequest()->isPost()){
           $redirectUrl = $this->aConfig["site"]["url"]."leader/docviolationshandling/listownerlessgoods";
...
//            $this->redirect($redirectUrl);
   ...
   ///
    ...
    public function editshandlingAction() {
         $id = $this->_getParam("id","");
        $redirectUrl=$this->aConfig["site"]["url"]."leader/docviolationshandling/list/type_business/DoanhNghiep";
        if(empty($id)){
            $this->_redirect($redirectUrl);
        }
    ...
    public function indexAction(){ 
         if($this->getRequest()->isPost()){
            $redirectUrl = $this->aConfig["site"]["url"]."leader/docviolationshandling/list";
            if(isset($_POST["id"])){
                $this->model->setId($_POST["id"]);
            }
...
//            exit();
    ...
    public function deleteAction(){
        $id= $this->_getParam("id","");
        $redirectUrl=$this->aConfig["site"]["url"]."leader/docprintcreate/list";               
